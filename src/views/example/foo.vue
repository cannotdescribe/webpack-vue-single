    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                axios.post('/api/book',querystring.stringify({
            ...
            createData() {
                this.$refs['dataForm'].validate((valid) => {
                    if (valid) {
                        ...
                        axios.post('/api/addbook',this.temp).then(response =>{
                            this.list.unshift(this.temp);
                            this.dialogFormVisible = false;
            ...
            updateData() {
                this.$refs['dataForm'].validate((valid) => {
                    if (valid) {
                        ...
                        axios.post('/api/updatebook',this.temp).then(response =>{
                            this.list.unshift(this.temp);
                            this.dialogFormVisible = false;
                            if(response.data.error == null) {
                                Notification({
            ...
            handleDelete(row) {
                ...
                axios.post('/api/deletebook',row).then(response => {
                    if(response.data.error == null) {
                        Notification({
                            title: '成功',
                            message: '删除成功',
